...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    assert_close(1 - sigmoid(a), sigmoid(a * -1))
...
def test_sum_distribute(ls1: List[float], ls2: List[float]) -> None:
    ...
    """
    sum_operator_result = sum(ls1) + sum(ls2)
    elementwise_result = 0
    for x in ls1 + ls2:
        elementwise_result += x
    assert_close(sum_operator_result, elementwise_result)
